...
2. remove "fips=`state'" from lines 60, 67, 95, 99, 148, 157, 161, 167, 171, 177, 181, 186 
...
3. Place a * in front of line 370. Line should read: *keep if state == `state'
...
* CHOOSE PARAMETERS
local year =  2015 // enter year here 
local grade = 8 // enter grade here
local state = 6  // enter state FIPS code here (https://www.mcc.co.mercer.pa.us/dps/state_fips_code_listing.htm)
